...
export function ExpandableRow({
  ...
  return (
    <div>
      <button onClick={onToggle} className="flex justify-between items-center w-full py-2 px-1.5 rounded-lg cursor-pointer group transition-colors duration-150 hover:bg-panel-hover">
